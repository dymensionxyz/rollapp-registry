...
1. Make sure you have successfully deployed and are running a RollApp instance.
...
10. Copy and paste the JSON output to the `<RollApp-ID>.json` file, and fill in the following fields:
